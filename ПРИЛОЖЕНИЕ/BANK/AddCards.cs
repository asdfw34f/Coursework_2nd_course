...
namespace BANK
{
    public partial class AddCards : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sqlCommand = new SqlCommand(@"insert into [ОФОРМЛЕННЫЕ_ДЕБЕТОВЫЕ_КАРТЫ]([НОМЕР_ПЛАСТИКА], [НОМЕР_ДОГОВОРА], [КОД_УСЛУГИ], [ПИН_КОД]) VALUES(@NUM, @DOG, @CODE, @PIN)", MyConnection.GetConnection());
            try
            {
